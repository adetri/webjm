...
<body>
  ...
  <div id="topbar" class="d-none d-lg-flex align-items-center fixed-top">
    <div class="container d-flex">
      <div class="contact-info mr-auto">
        ...
        <i class="icofont-phone"></i><?php echo $home['tlp']; ?>
        <i class="icofont-google-map"></i> <?php echo $home['alamat']; ?>
      </div>
  ...
  <header id="header" class="fixed-top">
    <div class="container d-flex align-items-center">
      ...
      <h1 class="logo mr-auto"><a href="index.html"><?php echo $home['nama_web']; ?></a></h1>
  ...
  <section id="hero" class="d-flex align-items-center">
    <div class="container">
      <h1>WELCOME TO <?php echo $home['nama_web']; ?></h1>
      ...
      <div class="container-fluid">
        ...
        <div class="row mt-5" >
          ...
          <div class="col-xl-7 col-lg-6 icon-boxes mt-5 d-flex flex-column align-items-stretch justify-content-center py-5 px-lg-5">
            <h3><?php echo $home['nama_web']; ?> MEANING</h3>
...
<?php include '../conn/koneksi.php';
      ...
      <div>
        <iframe style="border:0; width: 100%; height: 350px;" src="<?php echo $home['maps']; ?>" frameborder="0" allowfullscreen></iframe>
      </div>
          ...
          <div class="col-lg-4">
            <div class="info">
              <div class="address">
                ...
                <h4>Location:</h4>
                <p><?php echo $home['alamat']; ?></p>
           

              <div class="email">
                <i class="icofont-envelope"></i>
                <h4>Email:</h4>
                <p><?php echo $home['mail']; ?></p>
              </div>

              <div class="phone">
                <i class="icofont-phone"></i>
                <h4>Call:</h4>
                <p><?php echo $home['tlp']; ?></p>
              </div>
