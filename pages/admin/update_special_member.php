...
?>
	...
	<div class="container-fluid col-md-6 col-md-offset-3">
		<h2 style="text-align: center;">Update Data Special member</h2>
		<form action="../../system/prosesSpecialMember.php?aksi=update" method="post" enctype="multipart/form-data">
			...
			<div class="form-group">
			  ...
			  <div class="form-group">
				<label>Jabatan :</label>
				<input type="text" class="form-control" placeholder="Masukkan Nama" name="jabatan" value="<?php echo$d['jabatan']; ?>" required="required">
			</div>
			  <div class="form-group">
