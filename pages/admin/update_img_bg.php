...
?>
		...
		<form action="../../system/prosesHome.php?aksi=updatebg" method="post" enctype="multipart/form-data">
			<?php foreach ($db->edit($_GET['id']) as $d){
			 ?>
			<div class="form-group">
				<input type="hidden" class="form-control"  name="id" value="<?php echo $d['id']; ?>">
				<input type="hidden" class="form-control"  name="foto_lama" value="<?php echo $d['bg']; ?>">
