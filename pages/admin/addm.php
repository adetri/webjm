<?php include 'nav.php'; ?>
	...
	<div class="container-fluid col-md-6 col-md-offset-3">
		<h2 style="text-align: center;">Tambah Data Member</h2>
		<form action="../../system/prosesMember.php?aksi=tambah" method="post" enctype="multipart/form-data">
			<div class="form-group">
				<label>No Id :</label>
				<input type="text" class="form-control" placeholder="Masukkan Nama" name="no_id" required="required">
			</div>
			<div class="form-group">
				<label>Nama :</label>
