...
<div class="container-fluid">
	<div class="row">
		  <div class="col-md-9">
		  	<a href="addm.php" <button class="btn"  ><i class="fa fa-bars"></i> Tambah</button> </a>
	...
	<table class="table table table-bordered text-center" id="table-id">
	  <thead>
		<tr class="text-center">
		  ...
		  <th scope="col-md-5" class="text-center">Nama</th>
		  <th class=" text-center" >SCORE</th>
		  <th class="col-md-5 text-center" scope="col">Alamat</th>
		  <th  class="text-center" scope="col">Kontak</th>
		  <th  class="text-center" scope="col">Klinik</th>
		  <th class=" text-center col-md-1" scope="col">Foto</th>
